/*
  This Footers4ColumnWithNewsletterAndLocalizationDark requires some changes to your config:
...
export default function Footer4ColumnWithNewsletterAndLocalizationDark() {
  return (
