/*
  This Footers4ColumnWithNewsletterAndLocalization requires some changes to your config:
...
export default function Footer4ColumnWithNewsletterAndLocalization() {
  return (
